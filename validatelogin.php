...
#Build you vars
$user = 'admin user here';
$pass = 'admin pass here';
$url = 'http://yourdomain.tld/pathtowhmcs/includes/api.php'; #Be sure to change this to your WHMCS url 

#Now validate the client login http://docs.whmcs.com/API:Validate_Login
$postfields = array();
$postfields['username'] = $user;
$postfields['password'] = md5($pass);
$postfields['action'] = 'validatelogin';
$postfields['email'] = 'clients email here'; #Client's email address here
$postfields['password2'] = 'the password here'; #Client's password here
